...
function c511001371.initial_effect(c)
	...
	e1:SetCondition(c511001371.regcon)
	e1:SetOperation(c511001371.regop)
	c:RegisterEffect(e1)
	--draw
...
function c511001371.regcon(e,tp,eg,ep,ev,re,r,rp)
...
function c511001371.regop(e,tp,eg,ep,ev,re,r,rp)
