...
function c511002795.initial_effect(c)
	...
	e1:SetCondition(c511002795.condition)
	e1:SetTarget(c511002795.target)
	e1:SetOperation(c511002795.activate)
	c:RegisterEffect(e1)
	...
	e3:SetTarget(c511002795.destg)
	e3:SetValue(c511002795.desval)
	c:RegisterEffect(e3)
end
