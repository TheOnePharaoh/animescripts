--Extra Velier
function c511013004.initial_effect(c)
	--spsummon
	...
	e1:SetCondition(c511013004.spcon)
	e1:SetTarget(c511013004.sptg)
...
function c511013004.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and Duel.SpecialSummon(c,0,tp,tp,false,false,POS_FACEUP)~=0 then
		...
		e1:SetValue(c511013004.val)
		e1:SetReset(RESET_PHASE+PHASE_END)
		Duel.RegisterEffect(e1,tp)
	end
end
function c511013004.val(e,re,ev,r,rp,rc)
