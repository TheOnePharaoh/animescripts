...
function c511001781.initial_effect(c)
	...
	e1:SetCondition(c511001781.regcon)
	e1:SetOperation(c511001781.regop)
	c:RegisterEffect(e1)
...
function c511001781.regcon(e,tp,eg,ep,ev,re,r,rp)
...
function c511001781.regop(e,tp,eg,ep,ev,re,r,rp)
