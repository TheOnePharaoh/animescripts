...
function c511010165.initial_effect(c)
	...
	e1:SetCondition(c511010165.regcon)
	e1:SetOperation(c511010165.regop)
	c:RegisterEffect(e1)
	--addown
...
function c511010165.regcon(e,tp,eg,ep,ev,re,r,rp)
...
function c511010165.regop(e,tp,eg,ep,ev,re,r,rp)
