...
function c511001429.initial_effect(c)
	...
	e1:SetCondition(c511001429.regcon)
	e1:SetOperation(c511001429.regop)
	c:RegisterEffect(e1)
...
function c511001429.regcon(e,tp,eg,ep,ev,re,r,rp)
...
function c511001429.regop(e,tp,eg,ep,ev,re,r,rp)
