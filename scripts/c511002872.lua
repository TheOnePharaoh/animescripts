...
function c511002872.initial_effect(c)
	...
	e1:SetCondition(c511002872.regcon)
	e1:SetOperation(c511002872.regop)
	c:RegisterEffect(e1)
	--damage
...
function c511002872.regcon(e,tp,eg,ep,ev,re,r,rp)
...
function c511002872.regop(e,tp,eg,ep,ev,re,r,rp)
