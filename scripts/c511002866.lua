...
function c511002866.initial_effect(c)
	...
	e1:SetCondition(c511002866.regcon)
	e1:SetOperation(c511002866.regop)
	c:RegisterEffect(e1)
...
function c511002866.regcon(e,tp,eg,ep,ev,re,r,rp)
...
function c511002866.regop(e,tp,eg,ep,ev,re,r,rp)
