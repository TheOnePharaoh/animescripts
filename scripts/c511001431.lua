...
function c511001431.initial_effect(c)
	...
	e1:SetCondition(c511001431.regcon)
	e1:SetOperation(c511001431.regop)
	c:RegisterEffect(e1)
...
function c511001431.regcon(e,tp,eg,ep,ev,re,r,rp)
...
function c511001431.regop(e,tp,eg,ep,ev,re,r,rp)
