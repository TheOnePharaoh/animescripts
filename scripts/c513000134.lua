...
function c513000134.initial_effect(c)
	...
	e6:SetValue(c513000134.recon)
	c:RegisterEffect(e6)
	local e7=e6:Clone()
	e7:SetCondition(c513000134.recon2)
	...
	e8:SetValue(c513000134.tgfilter)
	c:RegisterEffect(e8)
	--immune effect
	...
	e9:SetValue(c513000134.efilter)
	c:RegisterEffect(e9)
	--indes
	...
	e11:SetCountLimit(1)
	e11:SetOperation(c513000134.atkdefresetop)
	...
	e12:SetCondition(c513000134.stgcon)
	...
	e15:SetCondition(c513000134.egpcon)
	e15:SetCost(c513000134.payatkcost)
	e15:SetOperation(c513000134.payatkop)
	...
	e16:SetCondition(c513000134.negcon)
	e16:SetOperation(c513000134.negop)
	...
	e18:SetCondition(c513000134.egpcon)
	e18:SetOperation(c513000134.egpop)
	...
	red:SetOperation(c513000134.redatk)
...
function c513000134.sumsuc(e,tp,eg,ep,ev,re,r,rp)
	Duel.SetChainLimitTillChainEnd(c513000134.chainlm)
end
function c513000134.chainlm(e,rp,tp)
...
function c513000134.efilter(e,te)
	return te:IsActiveType(TYPE_EFFECT) and te:GetOwner()~=e:GetOwner()
end
function c513000134.tgfilter(e,re)
...
function c513000134.tgg(c,card)
...
function c513000134.atkdefresetop(e,tp,eg,ep,ev,re,r,rp)
	...
	local tgg=Duel.GetMatchingGroup(c513000134.tgg,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,nil,c)
	eqg:Merge(tgg)
...
function c513000134.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	e1:SetOperation(c513000134.despop)
	e1:SetReset(RESET_CHAIN)
	e1:SetLabel(Duel.GetCurrentChain())
	Duel.RegisterEffect(e1,tp)
end
function c513000134.despfilter(c,tp)
	return c:GetSummonPlayer()~=tp
end
function c513000134.despop(e,tp,eg,ep,ev,re,r,rp)
	local g=eg:Filter(c513000134.despfilter,nil,tp)
...
function c513000134.negcon(e,tp,eg,ep,ev,re,r,rp)
...
function c513000134.negop(e,tp,eg,ep,ev,re,r,rp)
	Duel.NegateAttack()
end
...
function c513000134.redatk(e,tp,eg,ep,ev,re,r,rp)
	local a=Duel.GetAttacker()
