...
function c511001659.initial_effect(c)
	...
	e1:SetCondition(c511001659.regcon)
	e1:SetOperation(c511001659.regop)
	c:RegisterEffect(e1)
	--damage
...
function c511001659.regcon(e,tp,eg,ep,ev,re,r,rp)
...
function c511001659.regop(e,tp,eg,ep,ev,re,r,rp)
