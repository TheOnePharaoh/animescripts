...
function c511001139.rainbowfilter(c)
	return c:IsSetCard(0x2034) and (not c:IsOnField() or c:IsFaceup())
end
...
function c511001139.overdrivefilter(c)
	return c:IsFaceup() and c:IsSetCard(0x2034) and c:IsAbleToGraveAsCost()
end
...
function c511001139.protectionfilter(c)
	return c:IsSetCard(0x2034) and c:IsAbleToGraveAsCost()
end
