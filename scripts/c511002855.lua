...
function c511002855.initial_effect(c)
	...
	e1:SetCondition(c511002855.regcon)
	e1:SetOperation(c511002855.regop)
	c:RegisterEffect(e1)
	--negate
...
function c511002855.regcon(e,tp,eg,ep,ev,re,r,rp)
...
function c511002855.regop(e,tp,eg,ep,ev,re,r,rp)
