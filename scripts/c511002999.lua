...
function c511002999.initial_effect(c)
	...
	e1:SetTarget(c511002999.target)
	e1:SetOperation(c511002999.operation)
	c:RegisterEffect(e1)
	--Equip limit
	...
	e2:SetValue(c511002999.eqlimit)
	c:RegisterEffect(e2)
	--spsummon
...
function c511002999.eqlimit(e,c)
	return c:IsCode(110000104)
end
function c511002999.filter(c)
	return c:IsFaceup() and c:IsCode(110000104)
end
function c511002999.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_MZONE) and c511002999.filter(chkc) end
	if chk==0 then return Duel.IsExistingTarget(c511002999.filter,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_EQUIP)
	Duel.SelectTarget(tp,c511002999.filter,tp,LOCATION_MZONE,LOCATION_MZONE,1,1,nil)
	Duel.SetOperationInfo(0,CATEGORY_EQUIP,e:GetHandler(),1,0,0)
end
function c511002999.operation(e,tp,eg,ep,ev,re,r,rp)
